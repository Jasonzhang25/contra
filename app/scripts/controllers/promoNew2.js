...
.controller('promoNew2Ctrl', function($scope) {
    ...
    $scope.gridOptions = { 
        ...
        columnDefs: [
                     {field: 'test', displayName: 'Test', enableCellEdit: true},
                     {field: 'reason_code', displayName: 'Reason Code', enableCellEdit: true}, 
    ...
    $scope.myData2 = [{reason_code : "product_number"},
                    {reason_code : "product_number"},
                    {reason_code : "product_number"},
                    {reason_code : "product_number"},
                    {reason_code : "product_number"},
                    {reason_code : "product_number"},
